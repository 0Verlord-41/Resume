...
You can check it out here [0verlord-41.github.io/resume](https://0verlord-41.github.io/resume/)

### Special mention 
- Thanks to [@jai-dewani](https://github.com/jai-dewani) and [@ronaksakhuja](https://github.com/ronaksakhuja) and [@rajivnayanc](https://github.com/rajivnayanc) for sharing their [@ronaksakhuja/resume](https://github.com/ronaksakhuja/resume)  and &lt;private&gt; repositories for giving me an idea, how I can create an action for compiling the latex file to generate the PDF on the fly on every update (makes my life so easy) 
